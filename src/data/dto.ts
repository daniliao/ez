...
export const operationDTOSchema = z.object({
  ...
  operationProgress: z.number().positive().int(),
  operationProgressOf: z.number().positive().int(),
  operationPage: z.number().positive().int(),
  operationPages: z.number().positive().int(),
